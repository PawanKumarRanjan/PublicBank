...
public class Login extends JFrame implements ActionListener{
	...
	Login()
	{
		...
		JLabel text= new JLabel("Welcome to PUBLIC BANK");
		...
		cardno.setBounds(110,180,400,40);
		add(cardno);
		
		cardTextField=new JTextField();
		cardTextField.setBounds(360,187,250,30);
		...
		pinTextField.setBounds(360,237,250,30);
